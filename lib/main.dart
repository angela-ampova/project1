...
class _MyAppState extends State<MyApp> {
  ...
  var questions = [
    {'question':"Choose a category",
      'answer':['Female','Male','Kids',]},
    {'question':"Choose a brand",
      'answer':['Nike','Adidas','Reebok',]},
    {'question':"Choose a type",
      'answer':['Clothing','Accessories','Shoes',]},
  ];
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold (appBar: AppBar(title: Text("Viktorija Ampova 193022")),
      body: Column (
        children: [
